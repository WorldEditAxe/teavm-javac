...
public class Event {
  ...
  // These correspond to the legacy Processing event modifier layout.
  ...
  /**
   * Get the platform-native event object. Desktop, browser, and mobile
   * renderers can each provide different event object types.
