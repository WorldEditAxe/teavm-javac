...
public class PSurfaceNone implements PSurface {
  ...
  public PImage loadImage(String path, Object... args) {
    return PlatformRuntimeProvider.get().loadImage(sketch, path, args);
  }
...
//    PApplet.debug("done with pause");
  ...
  public class AnimationThread extends Thread {
     ...
     * Main loop for the platform surface.
     */
    @Override
    public void run() {  // not good to make this synchronized, locks things up
      long beforeTime = PlatformRuntimeProvider.get().nanoTime();
...
//        }
        ...
        long afterTime = PlatformRuntimeProvider.get().nanoTime();
        ...
        if (sleepTime > 0) {  // some time left in this cycle
          ...
          overSleepTime = (PlatformRuntimeProvider.get().nanoTime() - afterTime) - sleepTime;
        ...
        beforeTime = PlatformRuntimeProvider.get().nanoTime();
      }
