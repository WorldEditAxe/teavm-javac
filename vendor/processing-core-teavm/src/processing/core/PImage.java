...
public class PImage implements PConstants, Cloneable {
  ...
  @Deprecated
  public PImage(Object img) {
    PlatformRuntimeProvider.get().fromNativeImage(img, this);
  }
  ...
  public Object getNative() {  // ignore
    ...
    return PlatformRuntimeProvider.get().getNativeImage(this);
  }
  ...
  public void resize(int w, int h,int interpolationMode) {  // ignore
    ...
    PlatformRuntimeProvider.get().resizeImage(this, w, h, interpolationMode);
  }
  ...
  protected boolean saveImpl(String path) {
    ...
    try {
      ...
      if (lower.endsWith(".tga")) {
        ...
        //      https://github.com/processing/processing4/wiki/Image-loading-cleanup
        success = PlatformRuntimeProvider.get().saveImage(this, path);
      }
    } catch (IOException e) {
