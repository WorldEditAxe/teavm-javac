...
async function mountGeneratedWasmSketch(generated, element, options) {
    ...
    const runtimeModule = await import(String(options.sketchWasmRuntime ??
    ...
    const wasmRuntime = await runtimeModule.load(generated.wasmBytes, options.sketchWasmRuntimeOptions ?? options.wasmRuntimeOptions ?? options.runtimeOptions ?? {});
