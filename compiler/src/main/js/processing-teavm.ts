...
import {
  ...
  createJavaProgramOptions,
  decodedImageByToken,
  fetchFilePath,
  getCompilerWasmGCSupport,
  normalizeStorePath,
  setActiveProgram,
} from "./teavm-javac.js";
import type {
  ...
  JavaCompiler,
  JavaProgramConsoleOptions,
  JavaProgramFileSystemOptions,
  JavaProgramOptions,
...
export async function runProcessingSketches(options: ProcessingRunOptions = {}): Promise<ProcessingRunResult[]> {
...
export const runProcessingTags: typeof runProcessingSketches = runProcessingSketches;

export interface ProcessingProgramOptions extends JavaProgramOptions {
  sketchWasmRuntime?: string | URL;
  sketchWasmRuntimeUrl?: string | URL;
  sketchWasmRuntimeOptions?: Record<string, unknown>;
}

export function createProcessingProgramOptions(options: ProcessingProgramOptions = {}): ProcessingProgramOptions {
  return createJavaProgramOptions(options, openProcessingFilePath);
}

export async function createProcessingProgram(
  wasmBytes: BinaryInput,
  options: ProcessingProgramOptions = {}
): Promise<ProcessingProgram> {
...
export class ProcessingProgram {
  ...
  readonly options: ProcessingProgramOptions;

  constructor(wasmProgram, options: ProcessingProgramOptions = {}) {
  ...
  execute(canvasBackendOrOptions: unknown): unknown {
...
export async function runProcessingElement(
  element: Element,
...
export async function generateProcessingSketch(
...
export async function generateProcessingSketchOnMainThread(
  sources: Array<string | ProcessingSource>,
  options: ProcessingCompileOptions = {}
): Promise<ProcessingGeneratedSketch> {
...
export async function compileProcessingSketch(
  sources: Array<string | ProcessingSource>,
  options: ProcessingCompileOptions = {}
...
export async function preprocessProcessing(
  sources: Array<string | ProcessingSource>,
  options: ProcessingCompileOptions = {}
...
export async function emitProcessingSketchWithFallback(
  compiled: ProcessingCompileResult,
  options: ProcessingCompileOptions = {}
): Promise<ProcessingGeneratedSketch> {
