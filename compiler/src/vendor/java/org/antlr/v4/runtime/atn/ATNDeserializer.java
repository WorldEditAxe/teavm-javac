...
public class ATNDeserializer {
	 ...
	 */
	private static final SerializedUuid BASE_SERIALIZED_UUID;
	/**
	 * This UUID indicates an extension of {@link BASE_SERIALIZED_UUID} for the
	 * addition of precedence predicates.
	 */
	private static final SerializedUuid ADDED_PRECEDENCE_TRANSITIONS;
	/**
	 * This UUID indicates an extension of {@link #ADDED_PRECEDENCE_TRANSITIONS}
	 * for the addition of lexer actions encoded as a sequence of
	 * {@link LexerAction} instances.
	 */
	private static final SerializedUuid ADDED_LEXER_ACTIONS;
	/**
	 * This UUID indicates the serialized ATN contains two sets of
	 * IntervalSets, where the second set's values are encoded as
	 * 32-bit integers to support the full Unicode SMP range up to U+10FFFF.
	 */
	private static final SerializedUuid ADDED_UNICODE_SMP;
	/**
	 * This list contains all of the currently supported UUIDs, ordered by when
	 * the feature first appeared in this branch.
	 */
	private static final List<SerializedUuid> SUPPORTED_UUIDS;

	/**
	 * This is the current serialized UUID.
	 */
	public static final SerializedUuid SERIALIZED_UUID;
	static {
		/* WARNING: DO NOT MERGE THESE LINES. If UUIDs differ during a merge,
		 * resolve the conflict by generating a new ID!
		 */
		BASE_SERIALIZED_UUID = SerializedUuid.fromString("33761B2D-78BB-4A43-8B0B-4F5BEE8AACF3");
		ADDED_PRECEDENCE_TRANSITIONS = SerializedUuid.fromString("1DA0C57D-6C06-438A-9B27-10BCB3CE0F61");
		ADDED_LEXER_ACTIONS = SerializedUuid.fromString("AADB8D7E-AEEF-4415-AD2B-8204D6CF042E");
		ADDED_UNICODE_SMP = SerializedUuid.fromString("59627784-3BE5-417A-B9EB-8131A7286089");

		SUPPORTED_UUIDS = new ArrayList<SerializedUuid>();
	 ...
	 */
	static protected boolean isFeatureSupported(SerializedUuid feature, SerializedUuid actualUuid) {
	...
	public ATN deserialize(char[] data) {
		...
		SerializedUuid uuid = toUUID(data, p);
		p += 8;
...
//					   " "+arg1+","+arg2+","+arg3);
	...
	protected static SerializedUuid toUUID(char[] data, int offset) {
		long leastSigBits = toLong(data, offset);
		long mostSigBits = toLong(data, offset + 4);
		return new SerializedUuid(mostSigBits, leastSigBits);
	}

	public static final class SerializedUuid {
		private final long mostSigBits;
		private final long leastSigBits;

		private SerializedUuid(long mostSigBits, long leastSigBits) {
			this.mostSigBits = mostSigBits;
			this.leastSigBits = leastSigBits;
		}

		private static SerializedUuid fromString(String value) {
			long mostSigBits = 0;
			long leastSigBits = 0;
			int digits = 0;
		...
		public boolean equals(Object obj) {
			if (!(obj instanceof SerializedUuid)) {
				return false;
			}
			SerializedUuid other = (SerializedUuid) obj;
