...
public interface JavaParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JavaParser#baseStringLiteral}.
	 * @param ctx the parse tree
	 */
	void enterBaseStringLiteral(JavaParser.BaseStringLiteralContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#baseStringLiteral}.
	 * @param ctx the parse tree
	 */
	void exitBaseStringLiteral(JavaParser.BaseStringLiteralContext ctx);
	/**
	 * Enter a parse tree produced by {@link JavaParser#multilineStringLiteral}.
	 * @param ctx the parse tree
	 */
	void enterMultilineStringLiteral(JavaParser.MultilineStringLiteralContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#multilineStringLiteral}.
	 * @param ctx the parse tree
	 */
	void exitMultilineStringLiteral(JavaParser.MultilineStringLiteralContext ctx);
	/**
