...
public final class EventQueue {
    ...
    private static JSObject completionCallback;

    private EventQueue() {
    }

    public static void setCompletionCallback(JSObject callback) {
    ...
    @JSBody(params = { "callback" }, script = ""
            ...
            + "  callback();"
            + "}")
    private static native void complete(JSObject callback);
